...
CONTEXT_SURFACE_BROWSER_AI = "browser_ai"
CONTEXT_SURFACE_CLI_AI = "cli_ai"
CONTEXT_SURFACE_VSCODE_TERMINAL = "vscode_terminal"
CONTEXT_SURFACE_VSCODE_SIDE_CHAT = "vscode_side_chat"
CONTEXT_SURFACE_FUTURE_VSCODE_EXTENSION = "future_vscode_extension"
SUPPORTED_CONTEXT_SURFACES = (
    CONTEXT_SURFACE_BROWSER_AI,
    CONTEXT_SURFACE_CLI_AI,
    CONTEXT_SURFACE_VSCODE_TERMINAL,
    CONTEXT_SURFACE_VSCODE_SIDE_CHAT,
    CONTEXT_SURFACE_FUTURE_VSCODE_EXTENSION,
)
ADAPTER_NEUTRAL_CONTEXT_NOTE = (
    "Adapter-specific outputs must be derived from canonical context artifacts; "
