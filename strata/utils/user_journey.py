...
DIAGNOSTIC_BACKEND_FILE_TOO_LARGE = "backend_file_too_large"
DIAGNOSTIC_BACKEND_FILE_UNREADABLE = "backend_file_unreadable"
DIAGNOSTIC_BACKEND_UNSUPPORTED_FILE = "backend_unsupported_file"
DIAGNOSTIC_BACKEND_TRACE_DEPTH_CAP_REACHED = "backend_trace_depth_cap_reached"
DIAGNOSTIC_BACKEND_STEP_CAP_REACHED = "backend_step_cap_reached"
DIAGNOSTIC_BACKEND_TRANSITION_CAP_REACHED = "backend_transition_cap_reached"
DIAGNOSTIC_BACKEND_DYNAMIC_CALL_UNRESOLVED = "backend_dynamic_call_unresolved"
DIAGNOSTIC_BACKEND_SYMBOL_NOT_FOUND = "backend_symbol_not_found"
DIAGNOSTIC_JOURNEY_FRAGMENT_EMPTY = "journey_fragment_empty"
DIAGNOSTIC_JOURNEY_FRAGMENT_CONFLICT = "journey_fragment_conflict"
DIAGNOSTIC_JOURNEY_FRAGMENT_UNREACHABLE = "journey_fragment_unreachable"
DIAGNOSTIC_JOURNEY_BOUNDARY_UNRESOLVED = "journey_boundary_unresolved"
DIAGNOSTIC_JOURNEY_RESPONSE_PATH_UNRESOLVED = "journey_response_path_unresolved"
DIAGNOSTIC_JOURNEY_WORKSPACE_EDGE_MISSING = "journey_workspace_edge_missing"
DIAGNOSTIC_JOURNEY_WORKSPACE_EDGE_CONFLICT = "journey_workspace_edge_conflict"
DIAGNOSTIC_JOURNEY_CYCLE_DETECTED = "journey_cycle_detected"
DIAGNOSTIC_JOURNEY_MULTIPLE_ENTRY_POINTS = "journey_multiple_entry_points"
DIAGNOSTIC_JOURNEY_MULTIPLE_TERMINAL_STEPS = "journey_multiple_terminal_steps"
DIAGNOSTIC_JOURNEY_ASSEMBLY_CAP_REACHED = "journey_assembly_cap_reached"
DIAGNOSTIC_JOURNEY_PARTIAL_RESULTS_ASSEMBLED = "journey_partial_results_assembled"
DIAGNOSTIC_JOURNEY_CONTEXT_BUDGET_EXHAUSTED = "journey_context_budget_exhausted"
DIAGNOSTIC_JOURNEY_CONTEXT_TRUNCATED = "journey_context_truncated"
DIAGNOSTIC_JOURNEY_READINESS_BLOCKED = "journey_readiness_blocked"
DIAGNOSTIC_JOURNEY_READINESS_UNAVAILABLE = "journey_readiness_unavailable"
DIAGNOSTIC_JOURNEY_UNSUPPORTED_PATTERN = "journey_unsupported_pattern"
DIAGNOSTIC_CODES = (
    ...
    DIAGNOSTIC_BACKEND_FILE_TOO_LARGE,
    DIAGNOSTIC_BACKEND_FILE_UNREADABLE,
    DIAGNOSTIC_BACKEND_UNSUPPORTED_FILE,
    DIAGNOSTIC_BACKEND_TRACE_DEPTH_CAP_REACHED,
    DIAGNOSTIC_BACKEND_STEP_CAP_REACHED,
    DIAGNOSTIC_BACKEND_TRANSITION_CAP_REACHED,
    DIAGNOSTIC_BACKEND_DYNAMIC_CALL_UNRESOLVED,
    DIAGNOSTIC_BACKEND_SYMBOL_NOT_FOUND,
    DIAGNOSTIC_JOURNEY_FRAGMENT_EMPTY,
    DIAGNOSTIC_JOURNEY_FRAGMENT_CONFLICT,
    DIAGNOSTIC_JOURNEY_FRAGMENT_UNREACHABLE,
    DIAGNOSTIC_JOURNEY_BOUNDARY_UNRESOLVED,
    DIAGNOSTIC_JOURNEY_RESPONSE_PATH_UNRESOLVED,
    DIAGNOSTIC_JOURNEY_WORKSPACE_EDGE_MISSING,
    DIAGNOSTIC_JOURNEY_WORKSPACE_EDGE_CONFLICT,
    DIAGNOSTIC_JOURNEY_CYCLE_DETECTED,
    DIAGNOSTIC_JOURNEY_MULTIPLE_ENTRY_POINTS,
    DIAGNOSTIC_JOURNEY_MULTIPLE_TERMINAL_STEPS,
    DIAGNOSTIC_JOURNEY_ASSEMBLY_CAP_REACHED,
    DIAGNOSTIC_JOURNEY_PARTIAL_RESULTS_ASSEMBLED,
    DIAGNOSTIC_JOURNEY_CONTEXT_BUDGET_EXHAUSTED,
    DIAGNOSTIC_JOURNEY_CONTEXT_TRUNCATED,
    DIAGNOSTIC_JOURNEY_READINESS_BLOCKED,
    DIAGNOSTIC_JOURNEY_READINESS_UNAVAILABLE,
    DIAGNOSTIC_JOURNEY_UNSUPPORTED_PATTERN,
)
