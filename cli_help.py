...
def print_usage() -> None:
    ...
    print(f"  {cyan('execute')}       Check adapter execution readiness without running commands.")
    ...
    print(f"  {cyan('run')}           Build a workflow plan, prepare artifacts, and hand off to the configured adapter.")
